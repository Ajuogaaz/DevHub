...
public class OtherRepositoryAdapter extends RecyclerView.Adapter<OtherRepositoryAdapter.ViewHolder> {
    ...
    public OtherRepositoryAdapter(Context context, List<Repositories> repos, onClickListener clickListener) {
